...
function Frame2(props: Frame2Props): JSX.Element {
  return (
    <Frame21 id={44}   className={props.className}    aria-label={"test1"} >
      <Avatar1 variant="square" src={`assets/images/Avatar_10.png`} alt={"Avatar"}   />
      <Avatar2 variant="rounded" src={`assets/images/Avatar_9.png`} alt={"Avatar"}   />
      <Avatar3 variant="circular" src={`assets/images/Avatar_8.png`} alt={"Avatar"}   />
      <Avatar4 variant="square"  >OP</Avatar4>
      <Avatar5 id={22}  variant="square"  >OP</Avatar5>
      <Tooltip id={33} arrow={true} placement={"top"}  title={'hello'}>
        ...
        <Tooltip id={55} arrow={true} placement={"top"}  title={undefined}>
          <Frame3 id={"55"}   src={`assets/images/Frame_3.jpg`} alt={"Frame 3"}/>
        </Tooltip>
        </Badge>
      </Frame3Wrapper>
      <Popover  
