...
function Card18(props) {
  ...
  return (
    <TypeQuest onClick={fns.handleButton}  className={props.className}   >
      <Helmet>
        <title>Card-18</title>
      </Helmet>
      <Dialog  open={data.isOpen} onClose={fns.handleClose}>
        <Tooltip  arrow={true} placement={"bottom"}  title={"c"}>
          <Image onClick={() => {  ImageApi.start({ ...{ opacity: 0  }, delay: 0 });  }}  style={{ ...ImageSpring }}>
          </Image>
        </Tooltip>
        </Dialog>
      <Price >
